...
public enum ItemName {
	...
	public static ItemName valueOf(Material material, int durability) {
		try {
			return ItemName.valueOf(material.toString() + "__" + durability);
		} catch (Exception | Error e) {
			return ItemName.valueOf(material.toString() + "__0");
		}
	}
}